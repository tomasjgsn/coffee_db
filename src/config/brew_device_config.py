...
BREW_DEVICE_CONFIG: Dict[str, Dict[str, Any]] = {
    ...
    "V60": {
        ...
        "fields": {
            ...
            "v60_time_between_pours_s": {
                "type": "number",
                "label": "Time Between Pours (s)",
                "help": "Average time waited between pour phases",
                "default": None,
                "min": 0,
            },
            "v60_time_to_pour_s": {
                "type": "number",
                "label": "Time to Pour (s)",
                "help": "Average duration of each pour phase",
                "default": None,
                "min": 0,
            },
            "brew_total_time_s": {
